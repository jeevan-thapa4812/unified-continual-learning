...
def add_experiment_args(parser: ArgumentParser) -> None:
    ...
    parser.add_argument('--epoch-scaling', type=str, default='const',
                        help='How to scale the epochs for the current domain training.',
                        choices=['const', 'linear', 'sqrt'])
...
def add_management_args(parser: ArgumentParser) -> None:
    ...
    parser.add_argument('--wandb-entity', type=str, default='haizhou-shi',
                        help='Wandb entity')  # change it to your own wandb account.
